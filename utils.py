...
class DTADataset(InMemoryDataset):
    ...
    def process(self, xd, target_key, y, smile_graph, target_graph):
        ...
        for i in range(data_len):
            ...
            target_size, target_features, target_edge_index, is_stub, orig_target_edge_index = target_graph[tar_key]
            ...
            GCNData_pro = DATA.Data(x=torch.Tensor(target_features),
                                    ...
                                    y=torch.FloatTensor([labels]),
                                    is_stub=torch.BoolTensor(is_stub),
                                    orig_edge_index=torch.LongTensor(orig_target_edge_index).transpose(1, 0))
